...
class RejectionSamplerConfig:
    ...
    Usage (online)::
        ...
        vllm serve <model> --additional-config '{"rejection_sampler_config": {"enable_block_verify": true, "enable_entropy_verify": true}}'

    Usage (offline)::

        llm = LLM(model, additional_config={"rejection_sampler_config": {"enable_block_verify": true, "enable_entropy_verify": true}})
    """
