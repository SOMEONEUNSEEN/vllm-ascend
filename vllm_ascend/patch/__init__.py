...
#    Why:
#       Supported vLLM v0.23.0 predates newer DeepSeek V4 reasoning-effort
...
#    Related PR (if no, explain why):
#       Upstream vLLM main behavior after v0.23.0.
#    Future Plan:
...
#    Why:
#       vLLM 0.23.0 only emits MiniMax-M2 tool-call arguments after a complete
