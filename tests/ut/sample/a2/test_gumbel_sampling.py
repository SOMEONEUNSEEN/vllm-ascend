...
class TestGumbelSampling:
    ...
    def test_gumbel_sample_apply_temperature_true_nonzero(self):
        ...
        before adding Gumbel noise. Verify via logits_cache output.

        The cache stores the logits *before* temperature (upstream 81bc1969);
        consumers (the rejection sampler) divide by the same temperature on
        load."""
        ...
        # Use logits_cache to verify the pre-temperature logits are stored
    ...
    def test_gumbel_sample_processed_logits_req_state_idx(self):
        ...
        at the correct request slot. The cache stores pre-temperature logits
        (upstream 81bc1969).
        """
    ...
    def test_gumbel_sample_processed_logits_col(self):
        ...
        The cache stores pre-temperature logits (upstream 81bc1969).
        """
    ...
    def test_gumbel_sample_processed_logits_mixed_temp(self):
        ...
        the request's temperature (upstream 81bc1969).
